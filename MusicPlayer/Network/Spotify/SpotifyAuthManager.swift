...
final class SpotifyAuthManager{
    ...
    struct Constants{
        ...
        static let redirectURI: String = "https://open.spotify.com"
    }
    ...
    private var tokenExpirationDate: Date? {
        return UserDefaults.standard.object(forKey: Keys.experationDate) as? Date
    }
    ...
    private func cacheToken(result: AuthResponse) {
        UserDefaults.standard.setValue(result.access_token,
                                       forKey: Keys.access_token)
        if let refresh_token = result.refresh_token {
            UserDefaults.standard.setValue(refresh_token,
                                           forKey: Keys.refresh_token)
        }
        UserDefaults.standard.setValue(Date().addingTimeInterval(TimeInterval(result.expires_in)),
                                       forKey: Keys.experationDate)
    }
